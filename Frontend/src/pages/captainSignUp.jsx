    ...
    <img className='w-20 mb-1.5' src="data:image/png;base64," alt="" />
     <form onSubmit={(e) => {
      ...
      <input 
       ...
       <h3 className='text-lg font-medium mb-1.5'>Enter you'r email ?</h3>
       <input 
       required 
       className='bg-[#eeee] mb-4.5  rounded px-4 py-2 border w-full text-lg placholder:text-base' 
       type="email" 
       ...
       />
        <h3 className='text-lg font-medium mb-1.5'>Vehicle Information</h3>
          <div className='flex gap-4 mb-6.5'>
            <input
              required
       ...
       <button className='bg-black  text-white font-semibold mb-4.5  rounded px-4 py-2  w-full text-lg placholder:text-base'>Create Captain Account</button>
